 ...
 */
final class Version20240323144908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE course ADD COLUMN short_description VARCHAR(255) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__course AS SELECT id, sublevel_id, title, slug, video_url, content FROM course');
        ...
        $this->addSql('INSERT INTO course (id, sublevel_id, title, slug, video_url, content) SELECT id, sublevel_id, title, slug, video_url, content FROM __temp__course');
